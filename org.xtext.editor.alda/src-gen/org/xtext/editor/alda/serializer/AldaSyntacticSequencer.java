...
public class AldaSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_INSTRUMENTS_LineFeedKeyword_3_a;
	...
	protected void init(IGrammarAccess access) {
		...
		match_INSTRUMENTS_LineFeedKeyword_3_a = new TokenAlias(true, true, grammarAccess.getINSTRUMENTSAccess().getLineFeedKeyword_3());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_INSTRUMENTS_LineFeedKeyword_3_a.equals(syntax))
				emit_INSTRUMENTS_LineFeedKeyword_3_a(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_INSTRUMENTS_LineFeedKeyword_3_a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
